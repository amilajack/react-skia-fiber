...
import { createCkCanvas } from "./canvas";
import type { CkLineProps } from "./line";
import { createCkLine } from "./line";
import type { CkParagraphProps } from "./paragraph";
import { createCkParagraph } from "./paragraph";
import type { CkSurfaceProps } from "./surface";
import { createCkSurface } from "./surface";
import type { CkTextProps } from "./text";
import { createCkText } from "./text";
import type { SkObjectRef } from ".";
...
export interface CkObjectTyping {
  skSurface: { type: SkSurface; name: "SkSurface"; props: CkSurfaceProps };
  skCanvas: { type: SkCanvas; name: "SkCanvas"; props: CkCanvasProps };
  skLine: { type: never; name: "Line"; props: CkLineProps };
  skText: { type: never; name: "Text"; props: CkTextProps };
  skParagraph: {
    type: SkParagraph;
    name: "SkParagraph";
...
const CkElements: { [key in CkElementType]: CkElementCreator<any> } = {
  skText: createCkText,
  skLine: createCkLine,
  skSurface: createCkSurface,
  skCanvas: createCkCanvas,
  skParagraph: createCkParagraph,
};
